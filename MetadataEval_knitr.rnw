...
appropriate habitat (positive marginal effect on outcome). The distribution of each category (thin red = BG points, thick blue = PR points) is depicted at the top margin. 
